  ...
  return (
    <div className={styles.container}>
      <div className={styles.contentWrapper}>
        ...
        <div className={styles.aboutSection}>
          <h3 className={styles.sectionHeader}>Technical Domains</h3>
          <div className={styles.tagGrid}>
            <span className={styles.tag}>Frontend Development</span>
            <span className={styles.tag}>Backend Development</span>
            <span className={styles.tag}>Desktop Applications</span>
            <span className={styles.tag}>API Development</span>
            <span className={styles.tag}>Automation Engineering</span>
            <span className={styles.tag}>System Integration</span>
            <span className={styles.tag}>Database Design</span>
            <span className={styles.tag}>Application Architecture</span>
          </div>
        </div>

        <div className={styles.aboutSection}>
          <h3 className={styles.sectionHeader}>Technology Stack</h3>
          <div className={styles.tagGrid}>
            <span className={styles.tag}>JavaScript / TypeScript</span>
            <span className={styles.tag}>Python</span>
            <span className={styles.tag}>Frontend Frameworks</span>
            <span className={styles.tag}>Node.js Ecosystem</span>
            <span className={styles.tag}>SQL Databases</span>
            <span className={styles.tag}>NoSQL Databases</span>
            <span className={styles.tag}>REST APIs</span>
            <span className={styles.tag}>GraphQL</span>
            <span className={styles.tag}>Desktop Applications</span>
            <span className={styles.tag}>Automation & Testing</span>
          </div>
        </div>
      </div>
    </div>
